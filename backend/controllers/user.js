...
module.exports = {              //on exporte depuis ce module toutes les routes qu'il contient
////////////////////////////////////////////////////////////  
...
console.log(req.body)
    ...
    asyncLib.waterfall([
      ...
      function(done) {
        ...
        .then(function(userFound) { //où userFound = résultat de la requête
      ...
      function(userFound, done) {
        if (!userFound) {                       //si le paramètre existe
          bcrypt.hash(password, 5, function( err, bcryptedPassword ) {//on crypte le password
